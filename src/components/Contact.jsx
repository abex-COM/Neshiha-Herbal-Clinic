...
export default function Contact() {
  return (
    <section id="contact" className="py-16 bg-gradient-to-br from-emerald-50 to-teal-100">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ready to start your wellness journey? We're here to help you achieve optimal health naturally.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-emerald-100">
              ...
              <div
                className="w-full aspect-video rounded-xl bg-cover bg-center shadow-md border-2 border-emerald-200"
                style={{
                  backgroundImage:
              ...
              <div className="mt-4 p-4 bg-emerald-50 rounded-lg">
                <p className="text-sm text-gray-700 text-center">
                  <span className="font-medium">Easy to find!</span> We're located in the heart of Healthville, 
                  just off the main Wellness Avenue. Free parking available.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl p-6 text-white text-center shadow-lg">
              <h4 className="text-xl font-semibold mb-2">Need Immediate Assistance?</h4>
              <p className="text-emerald-100 mb-4">
                Our herbal medicine experts are ready to help you today
              </p>
              <button className="bg-white text-emerald-600 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-md">
